...
describe("useFormal()", () => {
  ...
  describe(".isValid", () => {
    ...
    it("should be false if the form contain errors", () => {
      ...
      act(() => result.current.setErrors({ firstName: "firstName should be unique" }));
  ...
  describe(".isValidating", () => {
    ...
    it.todo("should be true if the form is currently running any validation");
    it.todo("should be false when the form finish running any validation");
  });
  ...
  describe(".isSubmitting", () => {
    ...
    it.todo("should be true if the form is currently submitting");
    it.todo("should be false when the form finish submitting");
  });

  describe(".isSubmitted", () => {
    it.todo("should be initially false");
    it.todo("should be true when the form finish submitting");
  });
  ...
  describe(".validate()", () => {
    it("should throw an error if no schema is provided", () => {
      ...
      expect(() => result.current.validate()).toThrow(
        new Error("You cannot call validate if you have not provided any schema."),
      );
    });

    it.todo("should call clearErrors() before validating");
    it.todo("should change isValidating only if schema contains async validations");
    it.todo("should call setErrors() if the validation failed");
  });

  describe(".submit()", () => {
    it.todo("should call validate() before submitting");
    it.todo("should call onSubmit function passed with the current values");
  ...
  describe(".getFieldProps()", () => {
    describe(".disabled", () => {
      it.todo("should be true if the form is validating");
      it.todo("should be true if the form is submitting");
    });
    ...
    describe(".value", () => {
      it("should be the field value", () => {
        ...
        expect(result.current.getFieldProps("firstName").value).toEqual(initialValues.firstName);
      });
    });
    ...
    describe(".error", () => {
      ...
      it.todo("should return the error message if the field has error");
    });
  });
